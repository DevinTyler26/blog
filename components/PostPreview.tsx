...
const PostPreview = (props: PostMetadata) => {
  ...
  return (
    ...
    >
      <ImageWithFallback src={imagePath} alt={`hero image ${props.slug}`} width={700} height={400} className="object-cover" blurDataURL="/images/hero/no-image.jpg" placeholder="blur" />
      <div className="p-4">
